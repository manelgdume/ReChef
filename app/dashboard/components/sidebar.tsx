        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Link
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg bg-strongForeground text-accent-foreground transition-colors hover:text-white md:h-8 md:w-8"
            >
